...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>php-sdk/tests/bootstrap.php at master · facebook/php-sdk · GitHub</title>
...
<meta content="YRshv3q2lEOFld24xebvKLyMY1weyLvWq+yh4Q0VkeQ=" name="csrf-token" />
    ...
    <script defer="defer" src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-1c2730fbdc239b01736b846c4da36b642c1d1dfd.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/facebook/php-sdk/blob/6c82b3fdfb8efd27751de028d75fd3ab1f2c1ade/tests/bootstrap.php'>
  ...
  <body class="logged_out page-blob windows vis-public env-production " data-blob-contribs-enabled="yes">
    ...
    <ul class="top-nav logged_out">
      ...
      <li class="login"><a href="https://github.com/login?return_to=%2Ffacebook%2Fphp-sdk%2Fblob%2Fmaster%2Ftests%2Fbootstrap.php">Login</a></li>
    </ul>
            ...
            <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field">
              <div class="no-results js-not-filterable">Nothing to show</div>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/master/tests/bootstrap.php" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
            </div>
            ...
            <div class="js-filter-tab js-filter-tags" style="display:none" data-filterable-for="context-commitish-filter-field">
              <div class="no-results js-not-filterable">Nothing to show</div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v3.1.1/tests/bootstrap.php" class="js-navigation-open" data-name="v3.1.1" rel="nofollow">v3.1.1</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v3.1.0/tests/bootstrap.php" class="js-navigation-open" data-name="v3.1.0" rel="nofollow">v3.1.0</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v3.0.1/tests/bootstrap.php" class="js-navigation-open" data-name="v3.0.1" rel="nofollow">v3.0.1</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v3.0.0/tests/bootstrap.php" class="js-navigation-open" data-name="v3.0.0" rel="nofollow">v3.0.0</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.1.2/tests/bootstrap.php" class="js-navigation-open" data-name="v2.1.2" rel="nofollow">v2.1.2</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.1.1/tests/bootstrap.php" class="js-navigation-open" data-name="v2.1.1" rel="nofollow">v2.1.1</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.1.0/tests/bootstrap.php" class="js-navigation-open" data-name="v2.1.0" rel="nofollow">v2.1.0</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.0.7/tests/bootstrap.php" class="js-navigation-open" data-name="v2.0.7" rel="nofollow">v2.0.7</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.0.6/tests/bootstrap.php" class="js-navigation-open" data-name="v2.0.6" rel="nofollow">v2.0.6</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.0.4/tests/bootstrap.php" class="js-navigation-open" data-name="v2.0.4" rel="nofollow">v2.0.4</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.0.3/tests/bootstrap.php" class="js-navigation-open" data-name="v2.0.3" rel="nofollow">v2.0.3</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.0.2/tests/bootstrap.php" class="js-navigation-open" data-name="v2.0.2" rel="nofollow">v2.0.2</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.0.1/tests/bootstrap.php" class="js-navigation-open" data-name="v2.0.1" rel="nofollow">v2.0.1</a>
                  </h4>
                </div>
                <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target">
                  <h4>
                      <a href="/facebook/php-sdk/blob/v2.0.0/tests/bootstrap.php" class="js-navigation-open" data-name="v2.0.0" rel="nofollow">v2.0.0</a>
                  </h4>
                </div>
            </div>
          </div>
...
<!-- block_view_fragment_key: views7/v8/blob:v21:36d21b55d85c1426580e509ec7d61572 -->
  <div id="slider">
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="tests/bootstrap.php/" data-permalink-url="/facebook/php-sdk/blob/6c82b3fdfb8efd27751de028d75fd3ab1f2c1ade/tests/bootstrap.php" data-title="php-sdk/tests/bootstrap.php at master · facebook/php-sdk · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter js-rewrite-sha" href="/facebook/php-sdk/edit/6c82b3fdfb8efd27751de028d75fd3ab1f2c1ade/tests/bootstrap.php" data-method="post" rel="nofollow"><span>Edit this file</span></a>
                  </li>

                <li>
                  <a href="/facebook/php-sdk/raw/master/tests/bootstrap.php" class="minibutton btn-raw grouped-button bigger lighter" id="raw-url"><span><span class="icon"></span>Raw</span></a>
                </li>
                  <li>
                    <a href="/facebook/php-sdk/blame/master/tests/bootstrap.php" class="minibutton btn-blame grouped-button bigger lighter"><span><span class="icon"></span>Blame</span></a>
                  </li>
                <li>
                  <a href="/facebook/php-sdk/commits/master/tests/bootstrap.php" class="minibutton btn-history grouped-button bigger lighter" rel="nofollow"><span><span class="icon"></span>History</span></a>
                </li>
              </ul>
            </div>
...
<span id="L5" rel="#L5">5</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">&lt;?php</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="nv">$base</span> <span class="o">=</span> <span class="nb">realpath</span><span class="p">(</span><span class="nb">dirname</span><span class="p">(</span><span class="k">__FILE__</span><span class="p">)</span> <span class="o">.</span> <span class="s1">&#39;/..&#39;</span><span class="p">);</span></div><div class='line' id='LC4'><span class="k">require</span> <span class="s2">&quot;</span><span class="si">$base</span><span class="s2">/src/base_facebook.php&quot;</span><span class="p">;</span></div><div class='line' id='LC5'><span class="k">require</span> <span class="s2">&quot;</span><span class="si">$base</span><span class="s2">/src/facebook.php&quot;</span><span class="p">;</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.07092s from fe10.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.07423' data-host='fe10'></span>
  </body>
</html>
